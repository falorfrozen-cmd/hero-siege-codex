# Hero Siege Codex 0.5.0

The first standalone Scholar's Index release, presented here as a complete application for review. See [REVIEW.md](REVIEW.md) for the application map and validation commands.
